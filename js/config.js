...
.factory('LoginService', ['$http', '$location', '$rootScope', function($http,$location, $rootScope){
  return {
    login: function(user, scope){
      ...
      var $promise = $http.post('api/homigo.php/auth/process/admin', user);  // send data to server to user.php
    ...
    isLoggedIn: function(){
     var $checkSessionServer = $http.get('api/homigo.php/auth/process/admin');
